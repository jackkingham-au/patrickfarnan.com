...
const Footer = () => {
    return (
        <Box component="footer" sx={{py: 4, px: 1, bgcolor: 'secondary.main', mt: 2}}>
            <Container>
                <Image src="/assets/patrick-farnan-logo.jpg" alt="Patrick Farnan Logo" type="logo" styles={{height: '80px', width: 'auto'}} />
                <Grid container>
                    ...
                    <Grid item xs={12} md={6}>
                        <List dense sx={{color: '#fff'}}>
                            ...
                            <ListItemButton component="a" href="mailto:patrick@alwaysgofar.com">
                                <ListItemIcon sx={{color: 'primary.main'}}>  
                                    <EmailIcon />
                                </ListItemIcon>
                                <ListItemText primaryTypographyProps={{sx: {fontWeight: 'bold'}}}  primary="patrick@alwaysgofar.com" />
                            </ListItemButton>
