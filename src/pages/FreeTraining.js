...
const FreeTraining = () => {
    return (
        <Container>
            ...
            <Text align="center">Master Your Mindset FREE 5 Day Immersive Starts Sunday 24th July, and runs for 5 days concluding on Thursday 28th July.</Text>
            ...
            <Box sx={{bgcolor: 'primary.main', my: 4, p: 4}}>
                ...
                <Text>DAY 1 - Sunday July 24 @ 6:30pm AEST (Melbourne, AU)</Text>
                <Text>DAY 2 - Implementation Day</Text>
                <Text>DAY 3 - Tuesday July 26 @ 6:30pm AEST (Melbourne, AU)</Text>
                <Text>DAY 4 - Implementation Day</Text>
                <Text>DAY 5 - Thursday July 28 @ 6:30pm AEST (Melbourne, AU) - FINAL ZOOM GROUP CALL</Text>
            </Box>
