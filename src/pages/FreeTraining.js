...
const FreeTraining = () => {
    return (
        <Container>
            ...
            <Text align="center">Master Your Mindset FREE 6 Day Immersive Starts Tuesday 15th February, and runs for 6 days concluding on Sunday 20th February.</Text>
            ...
            <Box sx={{bgcolor: 'primary.main', my: 4, p: 4}}>
                ...
                <Text>DAY 1 - Tuesday February 15 @ 6:30pm AEDT</Text>
                <Text>DAY 2 - Implementation Day</Text>
                <Text>DAY 3 - Thursday February 17 @ 6:30pm AEDT</Text>
                <Text>DAY 4 & 5 - Implementation Days</Text>
                <Text>DAY 6 - Sunday February 20 @ 6:30pm AEDT - FINAL ZOOM GROUP CALL</Text>
            </Box>
